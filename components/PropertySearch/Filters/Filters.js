...
export const Filters = ({ onSearch }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto my-5 flex gap-5 border-solid border-slate-800 border-2 p-5 rounded-md">
